<html style="font-size: 16px;"><head>
         ...
         <div class="card">
             <div class="blogitem mb-5">
                 ...
                 <div class="blogitem-content">
                     ...
                     <h5><a href="">The Most Advance Business Plan</a></h5>
             ...
             <div class="blogitem mb-5">
                 <div class="blogitem-image">
                     <a href=""><img src="{{asset('assets/images/image-gallery/7.jpg')}}" alt="blog image"></a>
                     <span class="blogitem-date">Monday, December 15, 2018</span>
                 </div>
                 <div class="blogitem-content">
                     <div class="blogitem-header">
                     ...
                     <h5><a href="">WTCR from 2018: new rules, more cars, more races</a></h5>
             ...
             <div class="blogitem mb-5">
                 <div class="blogitem-image">
                     <a href=""><img src="{{asset('assets/images/image-gallery/8.jpg')}}" alt="blog image"></a>
                     <span class="blogitem-date">Monday, December 15, 2018</span>
                 </div>
                 <div class="blogitem-content">
                     <div class="blogitem-header">
                         <div class="blogitem-meta">
                             <span><i class="zmdi zmdi-account"></i>By <a href="javascript:void(0);">Michael</a></span>
                             <span><i class="zmdi zmdi-comments"></i><a href="">Comments(13)</a></span>
                         </div>
                         <div class="blogitem-share">
                             <ul class="list-unstyled mb-0">
                                 <li><a href="javascript:void(0);"><i class="zmdi zmdi-facebook-box"></i></a></li>
                     ...
                     <h5><a href="">All photographs are accurate. None of them is the truth</a></h5>
             ...
             <div class="blogitem">
                 <div class="blogitem-image">
                     <a href=""><img src="{{asset('assets/images/image-gallery/14.jpg')}}" alt="blog image"></a>
                     <span class="blogitem-date">Monday, December 15, 2018</span>
                 </div>
                 <div class="blogitem-content">
                     <div class="blogitem-header">
         ...
         <div class="card">
             ...
             <div class="body">
                 <ul class="list-unstyled mb-0 widget-recentpost">
                     <li>
                         <a href=""><img src="{{asset('assets/images/image-gallery/1.jpg')}}" alt="blog thumbnail"></a>
                         <div class="recentpost-content">
                             <a href="">Fundamental analysis services</a>
                             <span>August 01, 2018</span>
                         </div>
                     </li>
                     <li>
                         <a href=""><img src="{{asset('assets/images/image-gallery/2.jpg')}}" alt="blog thumbnail"></a>
                         <div class="recentpost-content">
                             <a href="">Steps to a successful Business</a>
                             <span>November 01, 2018</span>
                         </div>
                     </li>
                     <li>
                         <a href=""><img src="{{asset('assets/images/image-gallery/3.jpg')}}" alt="blog thumbnail"></a>
                         <div class="recentpost-content">
                             <a href="#">Development Progress Conference</a>
                             <span>December 01, 2018</span>
                         </div>
                     </li>
                     <li>
                         <a href=""><img src="{{asset('assets/images/image-gallery/12.jpg')}}" alt="blog thumbnail"></a>
                         <div class="recentpost-content">
                             <a href="">Steps to a successful Business</a>
 ...
 @stop
     ...
     {{-- <section class="u-clearfix u-section-1" id="sec-7391">
          ...
          @foreach ($post as $list )
             ...
             <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--blog_post_header-->
               <h4 class="u-blog-control u-text u-text-1">
                 <a class="u-post-header-link" href="../blog/post-5.html"><!--blog_post_header_content-->{{ $list->title }}<!--/blog_post_header_content--></a>
               </h4><!--/blog_post_header--><!--blog_post_image-->
               <a class="u-post-header-link" href="../blog/post-5.html"><img alt="" class="u-blog-control u-expanded-width u-image u-image-default u-image-1" src="{{ asset('assets/images/blog') }}/{{ $list->file }}"></a><!--/blog_post_image--><!--blog_post_content-->
               <div class="u-blog-control u-post-content u-text u-text-2 fr-view">{{ $list->post_text }}</div><!--/blog_post_content--><!--blog_post_readmore-->
               <a href="{{ url('singlepost') }}" class="u-blog-control u-border-2 u-border-palette-1-base u-btn u-btn-rectangle u-button-style u-none u-btn-1"><!--blog_post_readmore_content--><!--options_json--><!--{"content":"","defaultValue":"Read More"}--><!--/options_json-->Read More<!--/blog_post_readmore_content--></a><!--/blog_post_readmore-->
             </div>
           </div>
           @endforeach
